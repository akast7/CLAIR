...
In a retrospective study of 208 post-cardiac arrest patients, CLAIR achieved an **AUC-ROC of 0.94** (95% CI: 0.93–0.97), significantly outperforming CT-only baselines (AUC-ROC: 0.80, p = 0.03). Clinicians assisted by CLAIR also made fewer prognostic errors than in unassisted evaluations.
...
| Evaluator | Test Conditions | Errors (out of 20 difficult cases) |
|---|---|:---:|
